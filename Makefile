...
all: p1s
p1s: p1s.o code_block.o code_generation.o memory.o tier0.o tier1.o
	$(CC) $(CFLAGS) $(LDFLAGS) p1s.o code_block.o code_generation.o memory.o tier0.o tier1.o -o p1s
